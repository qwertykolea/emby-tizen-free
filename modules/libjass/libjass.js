define(["exports"], function (_exports) {
  ...
  require(['css!modules/libjass/libjass.css']);
  var libJASS = function (modules) {
    ...
    var BrowserReadableStream = function () {
      function BrowserReadableStream(stream, encoding) {
        ...
        this._decoder = new globalThis.TextDecoder(encoding, {
          ignoreBOM: true
        });
      }
      /**
    ...
    var OffsetTable = function () {
      var OffsetTableInner = function () {};
      __decorate([field(DataType.Uint16)], OffsetTableInner.prototype, "majorVersion", void 0);
      __decorate([field(DataType.Uint16)], OffsetTableInner.prototype, "minorVersion", void 0);
      __decorate([field(DataType.Uint16)], OffsetTableInner.prototype, "numTables", void 0);
      __decorate([field(DataType.Uint16)], OffsetTableInner.prototype, "searchRange", void 0);
      __decorate([field(DataType.Uint16)], OffsetTableInner.prototype, "entrySelector", void 0);
      __decorate([field(DataType.Uint16)], OffsetTableInner.prototype, "rangeShift", void 0);
      OffsetTableInner = __decorate([struct], OffsetTableInner);
      return OffsetTableInner;
    }();
    var TableRecord = function () {
      var TableRecordInner = function () {};
      __decorate([field(DataType.Char)], TableRecordInner.prototype, "c1", void 0);
      __decorate([field(DataType.Char)], TableRecordInner.prototype, "c2", void 0);
      __decorate([field(DataType.Char)], TableRecordInner.prototype, "c3", void 0);
      __decorate([field(DataType.Char)], TableRecordInner.prototype, "c4", void 0);
      __decorate([field(DataType.Uint32)], TableRecordInner.prototype, "checksum", void 0);
      __decorate([field(DataType.Uint32)], TableRecordInner.prototype, "offset", void 0);
      __decorate([field(DataType.Uint32)], TableRecordInner.prototype, "length", void 0);
      TableRecordInner = __decorate([struct], TableRecordInner);
      return TableRecordInner;
    }();
    var NameTableHeader = function () {
      var NameTableHeaderInner = function () {};
      __decorate([field(DataType.Uint16)], NameTableHeaderInner.prototype, "formatSelector", void 0);
      __decorate([field(DataType.Uint16)], NameTableHeaderInner.prototype, "count", void 0);
      __decorate([field(DataType.Uint16)], NameTableHeaderInner.prototype, "stringOffset", void 0);
      NameTableHeaderInner = __decorate([struct], NameTableHeaderInner);
      return NameTableHeaderInner;
    }();
    var NameRecord = function () {
      var NameRecordInner = function () {};
      __decorate([field(DataType.Uint16)], NameRecordInner.prototype, "platformId", void 0);
      __decorate([field(DataType.Uint16)], NameRecordInner.prototype, "encodingId", void 0);
      __decorate([field(DataType.Uint16)], NameRecordInner.prototype, "languageId", void 0);
      __decorate([field(DataType.Uint16)], NameRecordInner.prototype, "nameId", void 0);
      __decorate([field(DataType.Uint16)], NameRecordInner.prototype, "length", void 0);
      __decorate([field(DataType.Uint16)], NameRecordInner.prototype, "offset", void 0);
      NameRecordInner = __decorate([struct], NameRecordInner);
      return NameRecordInner;
    }();
    /**
    ...
    function getTtfNames(attachment) {
      ...
      var j;
      for (i = 0; i < nameTableHeader.count; i++) {
          ...
          case 6:
            ...
            switch (nameRecord.platformId) {
              ...
              case 3:
                {
                  var name_2 = "";
                  for (j = 0; j < nameBytes.length; j += 2) {
    ...
    var AnimationCollection = function () {
      ...
      AnimationCollection.prototype.add = function (timingFunction, keyframes) {
        ...
        var ruleCssText = "";
        var foreachFn = function (value, name) {
          ruleCssText += name + ":" + value + ";";
        };
        for (var _a = 0; _a < keyframes.length; _a++) {
          keyframe = keyframes[_a];
          ruleCssText += (100 * (end - start === 0 ? 1 : (keyframe.time - start) / (end - start))).toFixed(3) + "% {";
          keyframe.properties.forEach(foreachFn);
          ruleCssText += "}";
        }
        var animationName = "animation-" + this._id + "-" + this._numAnimations++;
        this._style.appendChild(document.createTextNode("@-webkit-keyframes " + animationName + "{" + ruleCssText + "}"));
        this._style.appendChild(document.createTextNode("@keyframes " + animationName + "{" + ruleCssText + "}"));
    ...
    var WebRenderer = function (_super) {
      ...
      function WebRenderer(ass, clock, libjassSubsWrapper, settings) {
        ...
        fontMap.forEach(function (srcs, fontFamily) {
          ...
          var attachedFontUrls;
          if (globalThis.document.fonts && globalThis.document.fonts.add) {
            ...
            attachedFontUrls = attachedFontsMap.get(fontFamily);
            ...
            globalThis.document.fonts.forEach(function (fontFace) {
            ...
            if (existingFontFaces.length === 0) {
              ...
              globalThis.document.fonts.add(quotedFontFace);
      ...
      WebRenderer.prototype.resize = function (width, height, left, top) {
        ...
        this._scaleX = width / (this.ass.properties.resolutionX || width);
        this._scaleY = height / (this.ass.properties.resolutionY || height);
      ...
      WebRenderer.prototype.draw = function (dialogue) {
        ...
        if (this._layerAlignmentWrappers[layer][alignment] === undefined) {
          ...
          layerWrapper = this._layerWrappers[layer];
          insertBeforeElement = null;
    ...
    var SpanStyles = function () {
      ...
      SpanStyles.prototype._setSvgOutlineOnSpan = function (filterWrapperSpan, outlineWidth, outlineHeight, outlineColor, primaryAlpha) {
        ...
        if (outlineWidth > 0 || outlineHeight > 0) {
          ...
          if (this._gaussianBlur > 0) {
            gaussianBlurFilter = document.createElementNS("http://www.w3.org/2000/svg", "feGaussianBlur");
          ...
          for (i = 0; i < this._blur; i++) {
            blurFilter = document.createElementNS("http://www.w3.org/2000/svg", "feConvolveMatrix");
      ...
      SpanStyles.prototype._setTextShadowOutlineOnSpan = function (span, outlineWidth, outlineHeight, outlineColor) {
        var _this = this;
        if ((outlineWidth > 0 || outlineHeight > 0) && isFinite(outlineWidth) && isFinite(outlineHeight)) {
    ...
    var ASS = function () {
      ...
      ASS.fromUrl = function (url, type) {
        ...
        var fetchPromise;
        if (typeof globalThis.fetch === "function" && typeof globalThis.ReadableStream === "function" && typeof globalThis.ReadableStream.prototype.getReader === "function" && typeof globalThis.TextDecoder === "function") {
          fetchPromise = globalThis.fetch(url).then(function (response) {
        ...
        return fetchPromise.catch(function (reason) {
          console.warn("fetch() failed, falling back to XHR: " + reason);
          var xhr = new XMLHttpRequest();
     ...
     * @memberOf libjass
     */
    exports.Promise = globalThis.Promise;
    ...
    var enqueueJob = function () {
      ...
      if (globalThis.process !== undefined && typeof globalThis.process.nextTick === "function") {
  ...
  var _default = _exports.default = libJASS;
});
