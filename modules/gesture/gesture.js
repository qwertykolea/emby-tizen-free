define(["exports", "./../dom.js"], function (_exports, _dom) {
  ...
  function TinyGesture(element, options) {
    ...
    _dom.default.addEventListener(this.element, 'touchstart', this._onTouchStart, {
      passive: true
    });
    this.element.addEventListener('touchmove', this._onTouchMove);
    _dom.default.addEventListener(this.element, 'touchend', this._onTouchEnd, {
      passive: true
    });
  }
  TinyGesture.prototype.destroy = function () {
    var _a, _b;
    _dom.default.removeEventListener(this.element, 'touchstart', this._onTouchStart, {
      passive: true
    });
    this.element.removeEventListener('touchmove', this._onTouchMove);
    _dom.default.removeEventListener(this.element, 'touchend', this._onTouchEnd, {
      passive: true
    });
  ...
  TinyGesture.prototype.on = function (type, fn) {
    var _this = this;
  ...
  TinyGesture.prototype.off = function (type, fn) {
    if (this.handlers[type]) {
  ...
  TinyGesture.prototype.fire = function (type, event) {
    for (var i = 0; i < this.handlers[type].length; i++) {
      this.handlers[type][i](event);
    }
  };
  TinyGesture.prototype.onTouchStart = function (event) {
    var _this2 = this;
    ...
    if (event.type !== 'mousedown') {
      ...
      if ((didTouch1 && event.changedTouches.length > 1 || !didTouch1) && !this.touch2) {
        this.touch2 = babelHelpers.toConsumableArray(event.changedTouches).find(function (touch) {
          var _a;
          return touch.identifier !== ((_a = _this2.touch1) === null || _a === void 0 ? void 0 : _a.identifier);
        }) || null;
  ...
  TinyGesture.prototype.onTouchMove = function (event) {
    var _this3 = this;
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o;
    if (event.type === 'mousemove' && (!this.touchStartX || this.touchEndX !== null)) {
      return;
    }
    var touch1 = undefined;
    var touch2 = undefined;
    if (event.type !== 'mousemove') {
      touch1 = babelHelpers.toConsumableArray(event.changedTouches).find(function (touch) {
        var _a;
        return touch.identifier === ((_a = _this3.touch1) === null || _a === void 0 ? void 0 : _a.identifier);
      });
      this.touchMove1 = touch1 || this.touchMove1;
      touch2 = babelHelpers.toConsumableArray(event.changedTouches).find(function (touch) {
        var _a;
        return touch.identifier === ((_a = _this3.touch2) === null || _a === void 0 ? void 0 : _a.identifier);
      });
      this.touchMove2 = touch2 || this.touchMove2;
    }
    if (event.type === 'mousemove' || touch1) {
      var touchMoveX = (event.type === 'mousemove' ? event.screenX : (_a = touch1 === null || touch1 === void 0 ? void 0 : touch1.screenX) !== null && _a !== void 0 ? _a : 0) - ((_b = this.touchStartX) !== null && _b !== void 0 ? _b : 0);
      this.velocityX = touchMoveX - ((_c = this.touchMoveX) !== null && _c !== void 0 ? _c : 0);
      this.touchMoveX = touchMoveX;
      var touchMoveY = (event.type === 'mousemove' ? event.screenY : (_d = touch1 === null || touch1 === void 0 ? void 0 : touch1.screenY) !== null && _d !== void 0 ? _d : 0) - ((_e = this.touchStartY) !== null && _e !== void 0 ? _e : 0);
  ...
  TinyGesture.prototype.onTouchEnd = function (event) {
    var _this4 = this;
    ...
    if (event.type !== 'mouseup') {
      touch1 = babelHelpers.toConsumableArray(event.changedTouches).find(function (touch) {
        var _a;
        return touch.identifier === ((_a = _this4.touch1) === null || _a === void 0 ? void 0 : _a.identifier);
      });
      if (!babelHelpers.toConsumableArray(event.touches).find(function (touch) {
        var _a;
        return touch.identifier === ((_a = _this4.touch1) === null || _a === void 0 ? void 0 : _a.identifier);
      })) {
        this.touch1 = null;
      ...
      if (!babelHelpers.toConsumableArray(event.touches).find(function (touch) {
        var _a;
        return touch.identifier === ((_a = _this4.touch2) === null || _a === void 0 ? void 0 : _a.identifier);
      })) {
        this.touch2 = null;
        this.touchMove2 = null;
      }
    ...
    if (event.type === 'mouseup' || touch1) {
      ...
      var x = this.touchEndX - ((_d = this.touchStartX) !== null && _d !== void 0 ? _d : 0);
      var absX = Math.abs(x);
      var y = this.touchEndY - ((_e = this.touchStartY) !== null && _e !== void 0 ? _e : 0);
      var absY = Math.abs(y);
      var distance = Math.sqrt(Math.pow(x, 2) + Math.pow(y, 2));
      var absDistance = Math.abs(distance);
      var diagonal = absY / absX;
      if (absX > this.thresholdX || absY > this.thresholdY || this.opts.diagonalSwipes && (absDistance > this.thresholdX || absDistance > this.thresholdY)) {
        ...
        if (this.doubleTapWaiting) {
          ...
          this.doubleTapTimer = setTimeout(function () {
            return _this4.doubleTapWaiting = false;
  ...
  TinyGesture.defaults = {
    threshold: function (type, _self) {
      return Math.max(25, Math.floor(0.15 * (type === 'x' ? _dom.default.getWindowSize().innerWidth : _dom.default.getWindowSize().innerHeight)));
    },
    velocityThreshold: 10,
    disregardVelocityThreshold: function (type, self) {
  ...
  var _default = _exports.default = TinyGesture;
});
