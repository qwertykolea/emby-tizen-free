define(["exports", "./../common/pluginmanager.js", "./../common/methodtimer.js"], function (_exports, _pluginmanager, _methodtimer) {
  ...
  function _default() {
    ...
    var interval;
    function animate() {
      var animations = [bounceInLeft, bounceInRight, swing, tada, wobble, rotateIn, rotateOut];
    ...
    self.show = function () {
      require(['css!modules/logoscreensaver/style.css'], function () {
        var elem = document.querySelector('.logoScreenSaver');
        if (!elem) {
          elem = document.createElement('div');
          elem.classList.add('logoScreenSaver');
          document.body.appendChild(elem);
          elem.innerHTML = '<img class="logoScreenSaverImage" src="' + _pluginmanager.default.mapPath(self, 'logowhite.png') + '" />';
        }
        stopInterval();
        interval = new _methodtimer.default({
          onInterval: animate,
          type: 'interval',
          timeoutMs: 3000
        });
