define(["exports"], function (_exports) {
  ...
  */
  function getCssData(options) {
    ...
    var sourceNodes = settings.include;
  ...
  function parseCss(css) {
    ...
    function at_rule() {
      whitespace();
      if (css[0] === "@") {
        var ret = at_x() || at_fontface() || at_media() || at_keyframes() || at_supports() || at_container() || at_document() || at_custom_m() || at_host() || at_page() || at_page_margin_box();
        return ret;
      }
    }
    function rule() {
  ...
  function stringifyCss(tree) {
    ...
    var renderMethods = {
      ...
      container: function container(node) {
        return "@container " + node.container + "{" + visit(node.rules) + "}";
      }
    };
  ...
  *     onFinally(hasChanged, hasNativeSupport)
  *   });
  */
  function cssVars() {
    ...
    function handleFinally(hasChanged) {
      settings.onFinally(Boolean(hasChanged));
    }
    ...
    getCssData({
      ...
      onComplete: function onComplete(cssText, cssArray) {
        ...
        var currentVars = Object.assign({}, variableStore.dom, variableStore.user);
        variableStore.job = {};
          ...
          if (node.__cssVars.tree) {
            try {
              ...
              if (outCss.length && hasCSSVarFunc) {
                ...
                var outNode = document.createElement("style");
  ...
  var _default = _exports.default = cssVars;
});
