...
function fetchFile(path, options) {
...
function nameMatch(a, b, normalize) {
  ...
  if (normalize) {
    if (removeLastPart(a) === removeLastPart(b)) {
      return true;
    }
  }
  a = a.replaceAll('-', '');
...
function findFontInArray(availableFonts, name, normalize) {
  for (var i = 0, length = availableFonts.length; i < length; i++) {
    var obj = Object.entries(availableFonts[i])[0];
    if (nameMatch(obj[0], name, normalize)) {
      return obj[1];
    }
  }
  return null;
}
function findFont(availableFonts, font) {
  var result = findFontInArray(availableFonts, font);
  if (result) {
    console.log('found font: ' + font);
    return result;
  }
  result = findFontInArray(availableFonts, font, true);
  if (result) {
    console.log('found font: ' + font);
    return result;
  }
...
function getBinaryPromise() {
  if (!wasmBinary && (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER)) {
    if (typeof fetch == "function" && !isFileURI(wasmBinaryFile)) {
      return fetchFile(wasmBinaryFile, {
...
ASS_Image.prototype["set_bitmap"] = ASS_Image.prototype.set_bitmap = function (arg0) {
  var self = this.ptr;
  ensureCache.prepare();
  if (arg0 && typeof arg0 === "object") arg0 = arg0.ptr;else arg0 = ensureString(arg0, false);
...
ASS_Style.prototype["set_Name"] = ASS_Style.prototype.set_Name = function (arg0) {
  var self = this.ptr;
  ensureCache.prepare();
  if (arg0 && typeof arg0 === "object") arg0 = arg0.ptr;else arg0 = ensureString(arg0, true);
...
libass.prototype["oct_set_fonts_dir"] = libass.prototype.oct_set_fonts_dir = function (priv, fonts_dir) {
  ...
  ensureCache.prepare();
  if (priv && typeof priv === "object") priv = priv.ptr;
  if (fonts_dir && typeof fonts_dir === "object") fonts_dir = fonts_dir.ptr;else fonts_dir = ensureString(fonts_dir, false);
...
libass.prototype["oct_set_fonts"] = libass.prototype.oct_set_fonts = function (priv, default_font, default_family, dfp, config, update) {
  ...
  ensureCache.prepare();
  if (priv && typeof priv === "object") priv = priv.ptr;
  if (default_font && typeof default_font === "object") default_font = default_font.ptr;else default_font = ensureString(default_font, false);
  if (default_family && typeof default_family === "object") default_family = default_family.ptr;else default_family = ensureString(default_family, false);
  if (dfp && typeof dfp === "object") dfp = dfp.ptr;
  if (config && typeof config === "object") config = config.ptr;else config = ensureString(config, false);
...
libass.prototype["oct_read_file"] = libass.prototype.oct_read_file = function (library, fname, codepage) {
  ...
  if (fname && typeof fname === "object") fname = fname.ptr;else fname = ensureString(fname, false);
  if (codepage && typeof codepage === "object") codepage = codepage.ptr;else codepage = ensureString(codepage, false);
...
libass.prototype["oct_add_font"] = libass.prototype.oct_add_font = function (library, name, data, data_size) {
  ...
  ensureCache.prepare();
  if (library && typeof library === "object") library = library.ptr;
  if (name && typeof name === "object") name = name.ptr;else name = ensureString(name, false);
  if (data && typeof data === "object") data = data.ptr;else data = ensureString(data, false);
...
SubtitleOctopus.prototype["createTrack"] = SubtitleOctopus.prototype.createTrack = function (subfile) {
  var self = this.ptr;
  ensureCache.prepare();
  if (subfile && typeof subfile === "object") subfile = subfile.ptr;else subfile = ensureString(subfile, false);
...
SubtitleOctopus.prototype["createTrackMem"] = SubtitleOctopus.prototype.createTrackMem = function (buf, bufsize) {
  var self = this.ptr;
  ensureCache.prepare();
  if (buf && typeof buf === "object") buf = buf.ptr;else buf = ensureString(buf, false);
...
self.writeFontToFS = function (font) {
  ...
  var foundFont = findFont(self.availableFonts, font);
  if (!foundFont) {
    return;
  }
  self.loadFontFile("font" + self.fontId++ + "-", foundFont);
};
